...
Skills have been published as an open standard. Like MCP, skills are designed to be portable across tools and platforms — the same skill should work whether you're using Claude or other AI platforms. Authors can note platform-specific requirements in the skill's `compatibility` field.
...
**1. Instructions too verbose** — Keep instructions concise, use bullet points, move detailed reference to separate files.
...
- **Public skills repository:** [github.com/anthropics/skills](https://github.com/anthropics/skills) — Anthropic-created skills you can customize
...
- **Bug reports:** GitHub Issues at `anthropics/skills/issues` — include skill name, error message, and steps to reproduce
